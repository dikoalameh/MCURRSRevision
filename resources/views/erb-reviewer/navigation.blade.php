        ...
        <ul class="m-4 text-lg p-0 bg-primary">
            ...
            <li>
                <a href="{{ url('/erb-reviewer/protocol-assign') }}"
                    class="w-full flex items-center px-2 py-3 border-none no-underline gap-x-3 hover:text-secondary transition-all duration-300 {{ Request::is('erb-reviewer/protocol-assign') || Request::is('erb-reviewer/forms/*/*') || Request::is('erb-reviewer/submit-documents/*') || Request::is('erb-reviewer/submitted-documents*') ? 'text-secondary' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <ul class="m-2 p-0 bg-primary">
                ...
                <li>
                    <a href="{{ url('/erb-reviewer/protocol-assign') }}"
                        ...
                        {{ Request::is('erb-reviewer/protocol-assign') || Request::is('erb-reviewer/forms/*/*') || Request::is('erb-reviewer/submit-documents/*') || Request::is('erb-reviewer/submitted-documents*') ? 'text-secondary' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-file-user-icon lucide-file-user">
                            <path
